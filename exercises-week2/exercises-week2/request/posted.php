...
class RequestFacade {
	...
	public static function getInt($value) {
        ...
        //return (integer)$value; ei palauta nullia
                 
           $paluuarvo=  filter_var ($value, FILTER_SANITIZE_NUMBER_INT); //eikä tääkään
            
           if (is_null($paluuarvo)) echo "NULLLLL"; else echo "ei nulli"; // ei oo
           return $paluuarvo;
